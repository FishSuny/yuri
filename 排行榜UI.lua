...
function initUI()
if 角色逻辑.m_level<(游戏设置.SHOWRANKLEVEL or 22)then
主界面UI.showTipsMsg(1,txt((游戏设置.SHOWRANKLEVEL or 22).."级才可查看排行榜"))
		return
	end
	if ui then
		uiLayer:removeChild(ui)
...
ui:setUIPack(g_mobileMode and UIPATH.."排行榜UIm.pack"or UIPATH.."排行榜UI.pack")
else
